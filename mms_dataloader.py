...
LabeledVendorA_data_dir = Base_dir + '/semi_medical/mnms_split_2D/data/Labeled/vendorA/'
LabeledVendorA_mask_dir = Base_dir + '/semi_medical/mnms_split_2D/mask/Labeled/vendorA/'
ReA_dir = Base_dir + '/semi_medical/mnms_split_2D_re/Labeled/vendorA/'

LabeledVendorB2_data_dir = Base_dir + '/semi_medical/mnms_split_2D/data/Labeled/vendorB/center2/'
LabeledVendorB2_mask_dir = Base_dir + '/semi_medical/mnms_split_2D/mask/Labeled/vendorB/center2/'
ReB2_dir = Base_dir + '/semi_medical/mnms_split_2D_re/Labeled/vendorB/center2/'

LabeledVendorB3_data_dir = Base_dir + '/semi_medical/mnms_split_2D/data/Labeled/vendorB/center3/'
LabeledVendorB3_mask_dir = Base_dir + '/semi_medical/mnms_split_2D/mask/Labeled/vendorB/center3/'
ReB3_dir = Base_dir + '/semi_medical/mnms_split_2D_re/Labeled/vendorB/center3/'

LabeledVendorC_data_dir = Base_dir + '/semi_medical/mnms_split_2D/data/Labeled/vendorC/'
LabeledVendorC_mask_dir = Base_dir + '/semi_medical/mnms_split_2D/mask/Labeled/vendorC/'
ReC_dir = Base_dir + '/semi_medical/mnms_split_2D_re/Labeled/vendorC/'

LabeledVendorD_data_dir = Base_dir + '/semi_medical/mnms_split_2D/data/Labeled/vendorD/'
LabeledVendorD_mask_dir = Base_dir + '/semi_medical/mnms_split_2D/mask/Labeled/vendorD/'
ReD_dir = Base_dir + '/semi_medical/mnms_split_2D_re/Labeled/vendorD/'

UnlabeledVendorC_data_dir = Base_dir + '/semi_medical/mnms_split_2D/data/Unlabeled/vendorC/'
UnReC_dir = Base_dir + '/semi_medical/mnms_split_2D_re/Unlabeled/vendorC/'
...
def get_meta_split_data_loaders(cfg, test_vendor='D', image_size=224, batch_size=1):
    random.seed(14)
    ...
    test_dataset = \
        get_data_loader_folder(cfg, Labeled_data_dir, Labeled_mask_dir, batch_size, image_size, test_num=test_vendor)

    return  domain_1_labeled_dataset, domain_2_labeled_dataset, domain_3_labeled_dataset, \
            domain_1_unlabeled_dataset, domain_2_unlabeled_dataset, domain_3_unlabeled_dataset, \
            test_dataset 

def get_data_loader_folder(cfg, data_folders, mask_folders, batch_size, new_size=288, test_num='D', num_workers=0):
    if test_num=='A':
    ...
    domain_1_labeled_dataset = ImageFolder(cfg, domain_1_img_dirs, domain_1_mask_dirs, domain_1_img_dirs, domain_1_re, fourier_dir=fourier_dirs, fourier_mask=fourier_masks, label=0, num_label=domain_1_num, train=True, labeled=True)
    domain_2_labeled_dataset = ImageFolder(cfg, domain_2_img_dirs, domain_2_mask_dirs, domain_1_img_dirs, domain_2_re, fourier_dir=fourier_dirs, fourier_mask=fourier_masks, label=1, num_label=domain_2_num, train=True, labeled=True)
    domain_3_labeled_dataset = ImageFolder(cfg, domain_3_img_dirs, domain_3_mask_dirs, domain_1_img_dirs, domain_3_re, fourier_dir=fourier_dirs, fourier_mask=fourier_masks, label=2, num_label=domain_3_num, train=True, labeled=True)

    print("loading unlabeled dateset")
    domain_1_unlabeled_dataset = ImageFolder(cfg, domain_1_img_dirs, domain_1_mask_dirs, domain_1_img_dirs, domain_1_re, fourier_dir=fourier_dirs, fourier_mask=fourier_masks, label=0, train=True, labeled=False)
    domain_2_unlabeled_dataset = ImageFolder(cfg, domain_2_img_dirs, domain_2_mask_dirs, domain_1_img_dirs, domain_2_re, fourier_dir=fourier_dirs, fourier_mask=fourier_masks, label=1, train=True, labeled=False)
    domain_3_unlabeled_dataset = ImageFolder(cfg, domain_3_img_dirs, domain_3_mask_dirs, domain_1_img_dirs, domain_3_re, fourier_dir=fourier_dirs, fourier_mask=fourier_masks, label=2, train=True, labeled=False)

    print("loading test dateset")
    test_dataset = ImageFolder(cfg, test_data_dirs, test_mask_dirs, domain_1_img_dirs, test_re, train=False, labeled=True)
...
class ImageFolder(data.Dataset):
    def __init__(self, cfg, data_dirs, mask_dirs, ref_dir, re, fourier_dir=None, fourier_mask=None, train=True, label=None, num_label=None, labeled=True, loader=default_loader):
...
if __name__ == '__main__':
    ...
    # save_image(img, './fpic/label__img.png')
    # save_image(aug_img, './fpic/label__aug_img.png')

    # mask = im_convert(mask, True)
    # save_image(mask, './fpic/label__mask.png')
